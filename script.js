...
// // // console.log(`Kristen is wearing a ${kristynsCloset[4]}, ${kristynsCloset[2]} and ${kristynsCloset[0]}.`);

// // // console.log(`Tom is wearing a ${thomsCloset[0][1]}, ${thomsCloset[1][2]} and ${thomsCloset[0][3]}.`);
